  ...
  return (
    <div className="container mx-auto max-w-4xl px-4 py-12 md:py-20 animate-fade-in">
      <div className="text-center mb-16">
        <Badge variant="info" className="mb-4">The Protocol</Badge>
        ...
        <p className="mt-6 text-lg text-text-secondary leading-relaxed max-w-2xl mx-auto">
          ChainBridge eliminates the need for trusted intermediaries, centralized 
          exchanges, or wrapped assets by leveraging Hash Time-Locked Contracts (HTLCs) 
          for direct cross-chain settlement.
        </p>
      </div>
      ...
      <div className="grid gap-8 md:grid-cols-2">
        <section className="space-y-6">
          ...
          <p className="text-text-secondary leading-relaxed">
            The platform acts as a coordinated gateway between multiple blockchains. 
            It uses a 2-step commitment process to ensure atomicity:
          </p>
          ...
          <Card className="p-6 space-y-4">
            <div className="flex gap-4">
              ...
              <p className="text-sm text-text-secondary">
                <span className="font-bold text-text-primary">Atomic Settlement:</span> Either both transactions succeed or both timeout and refund.
              </p>
            </div>
            <div className="flex gap-4">
              <div className="mt-1 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-brand-500/10 text-brand-500">
              ...
              <p className="text-sm text-text-secondary">
                <span className="font-bold text-text-primary">Network Integration:</span> Native support for Stellar Soroban, Bitcoin PSBTs, and Ethereum EVM.
              </p>
            </div>
          </Card>
